...
|----------|--------|----------|
| Android | APK | [GitHub Releases](https://github.com/0xSin/0xSin-AI/releases) |
| Windows | EXE, MSI | [GitHub Releases](https://github.com/0xSin/0xSin-AI/releases) |
| Linux | AppImage, DEB, RPM | [GitHub Releases](https://github.com/0xSin/0xSin-AI/releases) |
