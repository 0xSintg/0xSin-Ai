      ...
      <Show when={isSelectMode()} fallback={
        <div class="sidebar-header">
          <div class="sidebar-brand">
            <div class="brand-icon sinai-logo" />
            <span class="md-typescale-title-medium">0xSin AI</span>
          </div>
        ...
        <div class="confirm-dialog-backdrop" onClick={() => setAboutOpen(false)}>
          <div class="confirm-dialog about-dialog" onClick={(e) => e.stopPropagation()}>
            <div class="about-logo-container">
              <div class="about-logo sinai-logo" />
            </div>
            <h2 class="md-typescale-headline-small confirm-dialog-title">0xSin AI</h2>
            ...
            <div class="confirm-dialog-actions about-actions">
              <button
                ...
                onClick={(e) => { e.preventDefault(); platformOpenUrl("https://github.com/0xSin/0xSin-AI"); }}
              >
                GitHub
              </button>
